...
class PathologicalPartitioner(Partitioner):
    ...
    def __init__(
        ...
        num_partitions: int,
        partition_by: str,
        num_classes_per_partition: Union[int, float],
        ...
        self._num_classes_per_partition_int_or_float = num_classes_per_partition
        self._num_classes_per_partition: Optional[int] = None
    ...
    def load_partition(self, partition_id: int) -> datasets.Dataset:
        ...
        # partition indices.
        self._compute_num_partitions_to_int_if_needed()
    ...
    def _compute_num_partitions_to_int_if_needed(self) -> None:
        if isinstance(self._num_classes_per_partition_int_or_float, float):
